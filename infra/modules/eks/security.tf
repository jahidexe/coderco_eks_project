...
# 3. (Optional) EKS network-policy cluster—already attaches its SG in aws_eks_cluster.this
...
# 4. Pod Security Standards Namespaces
...
# 6. CloudWatch Agent Role & Policy
...
# 9. ▶️ Network ACL Associations
#    This block attaches the above NACL to every subnet.
...
# 10. Default Security Group Override (if needed – usually in VPC module)
